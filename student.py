...
class Student:
    def __init__(self,root):
        ...
        title = Label(self.root,text="Student Management System",bd = 10,relief=GROOVE,font=("times new roman ",40,"bold"),bg="#ff1493",fg="white")
    ...
    #======Manage Frane=========================================================
        ...
        lbl_roll = Label(Manage_Frame, text="Roll No:", bg="white", fg="black",font=("times new roman", 20, "bold"))
        lbl_roll.grid(row=1, column=0, pady=10,padx=20,sticky="w")

        txt_Roll = Entry(Manage_Frame,textvariable=self.Roll_no_var,font=("times new roman", 15, "bold"),bd=5,relief=GROOVE)
        txt_Roll.grid(row=1, column=1, pady=10,padx=20,sticky="w")

        lbl_name = Label(Manage_Frame, text="Name:", bg="white", fg="black", font=("times new roman", 20, "bold"))
        ...
        lbl_DOB = Label(Manage_Frame, text="DOB:", bg="white", fg="black",font=("times new roman", 20, "bold"))
        lbl_DOB.grid(row=6, column=0, pady=10, padx=20, sticky="w")

        txt_DOB = Entry(Manage_Frame,textvariable=self.dob_var ,font=("times new roman", 15, "bold"), bd=5, relief=GROOVE)
        txt_DOB.grid(row=6, column=1, pady=10, padx=20, sticky="w")

        lbl_Address = Label(Manage_Frame, text="Address:", bg="white", fg="black",font=("times new roman", 20, "bold"))
    ...
    #==========================Button Frme+++++++++++++++++++++++++++++++++++++++++++++++++++
        ...
        Addbtn  = Button(btn_Frame,text="Add",width=10,command=self.add_students,bg="#ff1493").grid(row=0,column=0,padx=10,pady=10)
        updatebtn = Button(btn_Frame, text="Update", width=10, command=self.update_data,bg="#ff1493").grid(row=0, column=1, padx=10, pady=10)
        deletebtn  = Button(btn_Frame,text="Delete",width=10,command=self.delete_data,bg="#ff1493").grid(row=0,column=2,padx=10,pady=10)
        clearbtn = Button(btn_Frame, text="Clear", width=10,command=self.clear,bg="#ff1493").grid(row=0, column=3, padx=10, pady=10)
...
#==============Table Frame===================================================================================
    ...
    def add_students(self):
        if self.Roll_no_var.get()=="" or self.name_var.get()=="":
            messagebox.showerror("Error","All fields are required to filled")
        else:
    ...
    def update_data(self):
        if self.Roll_no_var.get()=="" or self.name_var.get()=="":
            messagebox.showerror("Error","All fields are equired to filled")
        else:
            con=pymysql.connect(host="localhost",user="root",password="",database="sms2")
            cur=con.cursor()
